...
import com.userdoctor.ui.common.activity.Lab_Nursing.Home_Vaccination.Activity.UI.Activity.Vaccination_Time_Page;
...
import com.userdoctor.ui.common.activity.Lab_Nursing.Sample_Collection.Model_Adapter.SubTimeAdapter;
import com.squareup.picasso.Picasso;
import java.util.ArrayList;
import java.util.List;

    public class VaccinationTimeAdapter extends RecyclerView.Adapter<VaccinationTimeAdapter.ViewHolder> {
        ...
        SubTimeVaccinationAdapter subTimeVaccinationAdapter;
        ...
        public VaccinationTimeAdapter(List<VaccinationTimeDatum> datum, Vaccination_Time_Page activity) {
        ...
        @NonNull
        @Override
        public VaccinationTimeAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.vaccination_item_time_formate, parent, false);
            return new VaccinationTimeAdapter.ViewHolder(itemView);
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            if (contactModels.size() > 0) {
               ...
               subTimeVaccinationAdapter=new SubTimeVaccinationAdapter(contactModel.getTimeSlotVaccs(), context);
               ...
               holder.recyclerView.setLayoutManager(manager);
                ...
                holder.recyclerView.setAdapter(subTimeVaccinationAdapter);
